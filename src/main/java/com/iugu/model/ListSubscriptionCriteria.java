...
public class ListSubscriptionCriteria implements Serializable {

	private static final long serialVersionUID = 7011503852410117830L;
	...
	public static class Builder {
	    ...
	    public ListSubscriptionCriteria build() {
	        return new ListSubscriptionCriteria(this);
	      }
	}
	
	private ListSubscriptionCriteria(Builder builder) {
		limit = builder.limit;
		start = builder.start;
